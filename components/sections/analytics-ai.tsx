 ...
 * написано — обещать неготовое на странице продукта нельзя. Плашка «в
 * разработке» поэтому янтарная: это единственный цвет предупреждения в
 * продукте, и здесь он означает ровно то же.
 */
    ...
    <Section>
      <Shell>
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-14">
          <div>
            <SectionHead eyebrow={d.ai.eyebrow} title={d.ai.title} lead={d.ai.lead} />

            <Reveal delay={100} className="glass-soft mt-8 rounded-2xl p-5">
              ...
              <p className="mt-2.5 text-[14px] leading-relaxed text-snow-2">{d.ai.devText}</p>
            </Reveal>
          </div>
